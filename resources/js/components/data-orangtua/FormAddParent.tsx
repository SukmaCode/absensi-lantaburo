...
import { Check, LoaderCircle, Search, UserCheck, Users, X } from 'lucide-react';
...
import type { AvailableStudentOption } from '@/types/admin';
        ...
        <form onSubmit={submit} className="space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="grid gap-2 sm:col-span-2">
                    ...
                    >
                        <SelectTrigger id="status" className="w-full text-black rounded-xs">
            ...
            <div className="space-y-2 rounded-lg border border-neutral-200 bg-neutral-50/50 p-3.5">
                ...
                <p className="text-xs text-brand-muted">
                    Pilih satu atau lebih siswa yang merupakan anak dari orang tua ini.
                </p>
